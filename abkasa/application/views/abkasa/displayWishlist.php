                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    <table class="table table-bordered"> 
                                        ...
                                        <?php foreach ($wishlist as $items): ?>
                                            <form method="post" id="cart-form" action="<?php echo base_url('cart/updateCart'); ?>">
                                                <tr>
                                                    <td style="text-align:center"> <img src="<?php echo base_url('uploads/product/' . $items['main_image']);?>" height="200px" width="200px"/></td>
                                                    <td style="text-align:center"><?php echo $items['title']; ?></td>
...
<!--                                        <tr>
                    ...
                    <?php } else {
                        ?>
                        <h3 style="text-align: center">Wish List is empty</h3>
                    <?php }
                    ?>
                </div>
            </div>
