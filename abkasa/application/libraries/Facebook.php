...
Class Facebook {
    ...
    public function login_url() {
        ...
        return $this->helper->getLoginUrl(
                        $this->config->item('facebook_login_redirect_url'), $this->config->item('facebook_permissions')
        );
    }
    ...
    public function logout_url() {
        ...
        return $this->helper->getLogoutUrl(
                        $this->get_access_token(), base_url() . $this->config->item('facebook_logout_redirect_url')
        );
    }
