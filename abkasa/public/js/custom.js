var token = '9432735105.1677ed0.08a4b44900e34e1eacc3b086dab70685', // learn how to obtain it below
        userid = 9432735105, // User ID - get it in source HTML of your Instagram profile
...
$.ajax({
    ...
    success: function (data) {
        console.log(data);
        for (x in data.data) {
            $('.instafeeds').append('<div class="colsdiv"><img src="' + data.data[x].images.low_resolution.url + '" class="img-responsive"></div>'); // data.data[x].images.low_resolution.url - URL of image, 306Ñ…306
...
$('.sizechecklink').click(function () {
    $('.sizechecklink').removeClass('active');
    $(this).addClass('active');
});
$(window).load(function () {
    setTimeout(function () {
...
$('#brand').each(function(){
    ...
    $this.wrap('<div class="selectsize"></div>');
